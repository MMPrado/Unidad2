package mx.edu.utng.mmacias.compartir;
...
public class MainActivityCompartir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compartir_imagen);
    ...
    private void showOptions() {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(MainActivityCompartir.this);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode == MY_PERMISSIONS){
            if(grantResults.length == 2 && grantResults[0] == PackageManager.PERMISSION_GRANTED && grantResults[1] == PackageManager.PERMISSION_GRANTED){
                Toast.makeText(MainActivityCompartir.this, "Permisos aceptados", Toast.LENGTH_SHORT).show();
    ...
    private void showExplanation() {
        AlertDialog.Builder builder = new AlertDialog.Builder(MainActivityCompartir.this);
